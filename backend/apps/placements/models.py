    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(
                fields=['college', 'name'],
                name='unique_company_per_college',
            )
        ]
...
class JobPosting(TimeStampedModel):
    ...
    company = models.ForeignKey(
        Company, on_delete=models.CASCADE, related_name='postings',
    )
    title = models.CharField(max_length=255)
    description = models.TextField()
    job_type = models.CharField(
        max_length=50, choices=JOB_TYPES, default='FULL_TIME',
    )
...
class StudentSkill(TimeStampedModel):
    ...
    student = models.ForeignKey(
        'academics.Student', on_delete=models.CASCADE, related_name='skills',
    )
    skill = models.ForeignKey(Skill, on_delete=models.CASCADE)
...
class JobApplication(TimeStampedModel):
    ...
    student = models.ForeignKey(
        'academics.Student', on_delete=models.CASCADE, related_name='applications',
    )
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(
                fields=['job', 'student'],
                name='unique_application_per_student_job',
            )
        ]
